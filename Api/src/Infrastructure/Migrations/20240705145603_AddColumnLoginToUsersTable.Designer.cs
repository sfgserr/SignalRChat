...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240705145603_AddColumnLoginToUsersTable")]
    partial class AddColumnLoginToUsersTable
    {
        /// <inheritdoc />
                            ...
                            b1.OwnsOne("Domain.Groups.GroupUserRole", "Role", b2 =>
                                {
                                    ...
                                    b2.HasKey("GroupUserUserId", "GroupUserGroupId");
                                    ...
                                    b2.OwnsMany("Domain.Groups.GroupUserPermission", "Permissions", b3 =>
                                        {
                                            b3.Property<Guid>("GroupUserRoleGroupUserUserId")
                                                .HasColumnType("uniqueidentifier");

                                            b3.Property<Guid>("GroupUserRoleGroupUserGroupId")
                                                .HasColumnType("uniqueidentifier");
                                            ...
                                            b3.HasKey("GroupUserRoleGroupUserUserId", "GroupUserRoleGroupUserGroupId", "Id");

                                            b3.ToTable("GroupUserPermissions", (string)null);

                                            b3.WithOwner()
                                                .HasForeignKey("GroupUserRoleGroupUserUserId", "GroupUserRoleGroupUserGroupId");
                                        });
